...
const ProductPage = () => {
  return (
    <> <Header/>
      ...
      <div className="flex flex-wrap items-center justify-between mt-8 px-4">
        {/* Text Section */}
        <div className="flex items-center gap-6"> {/* Align everything in a single line */}
  {/* Heading */}
  <div className="flex flex-col w-full sm:w-1/4"> {/* Adjust width for smaller screens */}
  ...
  {/* Product Card 1 */}
  <div className="flex flex-col w-full sm:w-1/4"> {/* Each product card takes 1/4 of the width */}
    <Image
      src="/Group 156.png"
      alt="sec1"
      width={280}
  ...
  {/* Add Product Section */}
  <div className="flex flex-col w-full sm:w-1/4"> {/* Add Product section also takes 1/4 of the width */}
